...
public class Spider
{
//    public static StringExtractor stringExtractor = new StringExtractor();
//
//    public static LinkExtractor linkExtractor = new LinkExtractor();
...
//                Vector<String> links = linkExtractor.extractLinks(url);
