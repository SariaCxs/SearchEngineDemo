package application.spider;// HTMLParser Library $Name: v1_6 $ - A java-based parser for HTML
 ...
 * Uses a {@link StringBean StringBean} to accumulate
...
public class StringExtractor
{
     ...
     */
    public String extractStrings (boolean links, String resource)
        throws
            ParserException
    {
        StringBean sb;
    ...
    public static void main (String[] args)
    {
        ...
        if (null != url)
        {
            se = new StringExtractor ();
            try
            {
                System.out.println (se.extractStrings (links,url));
            }
